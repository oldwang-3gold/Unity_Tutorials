...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaTestLuaBehaviour2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLuaTest.LuaBehaviour2);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new XLuaTest.LuaBehaviour2();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaTest.LuaBehaviour2 constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                XLuaTest.LuaBehaviour2 gen_to_be_invoked = (XLuaTest.LuaBehaviour2)translator.FastGetCSObj(L, 1);
